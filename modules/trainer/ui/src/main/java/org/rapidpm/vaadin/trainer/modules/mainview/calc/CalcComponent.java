...
import static org.rapidpm.vaadin.ComponentIDGenerator.genericID;
import static org.rapidpm.vaadin.ComponentIDGenerator.labelID;
...
import org.rapidpm.vaadin.trainer.modules.mainview.calc.basics.CalcBasicsService;
...
public class CalcComponent extends Composite {
  ...
  public static final String CALC_COMPONENT_CHART_RESULT_TITLE = "calc.component.chart.result.title";
