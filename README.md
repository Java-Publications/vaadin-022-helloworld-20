...
# Backend meets Frontend: See and implement changes in the UI faster
Small changes to the user interface should also be able to test fixed, without the developer having to work through eternally long clicks and take unnecessary loading times. A clearly separated component model also helps here.
...
* german article [http://bit.ly/jaxenter-020](http://bit.ly/jaxenter-020)
